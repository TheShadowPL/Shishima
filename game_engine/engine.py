...
class GameEngine:
    ...
    def reset_game(self):
        ...
        self.positions[7], self.positions[0], self.positions[1] = 'Gracz 1', 'Gracz 1', 'Gracz 1'
        self.positions[3], self.positions[4], self.positions[5] = 'Gracz 2', 'Gracz 2', 'Gracz 2'
        self.current_player = 'Gracz 1'
    ...
    def switch_player(self):
        self.current_player = 'Gracz 2' if self.current_player == 'Gracz 1' else 'Gracz 1'
